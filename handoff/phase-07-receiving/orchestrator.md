...
- Append your work log to `handoff/phase-07-receiving/backend.md`.
...
Handoff Requirements
- Append your work log to `handoff/phase-07-receiving/frontend.md`.
- Use the section shape required by `handoff/README.md`.
...
Handoff Requirements
- Append your work log to `handoff/phase-07-receiving/testing.md`.
- Use the section shape required by `handoff/README.md`.
