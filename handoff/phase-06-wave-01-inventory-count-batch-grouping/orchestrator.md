...
- Append your work log to `handoff/phase-06-wave-01-inventory-count-batch-grouping/frontend.md`.
...
- `stoqio_docs/08_SETUP_AND_GLOBALS.md` § 4, § 5
- `handoff/phase-06-wave-01-inventory-count-batch-grouping/orchestrator.md`
- `handoff/phase-06-wave-01-inventory-count-batch-grouping/frontend.md`
- `handoff/phase-12-inventory-count/orchestrator.md`
...
```bash
git status --short
git diff -- frontend/src/pages/inventory/InventoryCountPage.tsx handoff/phase-06-wave-01-inventory-count-batch-grouping/frontend.md handoff/phase-06-wave-01-inventory-count-batch-grouping/orchestrator.md
cd frontend && npm run lint
cd frontend && npm run build
```
