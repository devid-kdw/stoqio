...
4. Record the full work trail in `handoff/implementation/phase-02-database-models/backend.md`.
...
- Append your work log to `handoff/implementation/phase-02-database-models/backend.md`.
