...
- Append your work log to `handoff/wave-02/phase-01-wave-02-draft-group-partial-status/backend.md`.
...
Handoff Requirements
- Append your work log to `handoff/wave-02/phase-01-wave-02-draft-group-partial-status/frontend.md`.
- Use the section shape required by `handoff/README.md`.
...
Handoff Requirements
- Append your work log to `handoff/wave-02/phase-01-wave-02-draft-group-partial-status/testing.md`.
- Use the section shape required by `handoff/README.md`.
...
Docs Read
- `handoff/wave-02/phase-01-wave-02-draft-group-partial-status/backend.md`
- `handoff/wave-02/phase-01-wave-02-draft-group-partial-status/frontend.md`
- `handoff/wave-02/phase-01-wave-02-draft-group-partial-status/testing.md`
- `handoff/decisions/decision-log.md` (`DEC-APP-001`)
