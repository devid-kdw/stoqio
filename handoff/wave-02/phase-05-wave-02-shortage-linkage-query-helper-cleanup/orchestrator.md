...
You are not alone in the codebase. Do not revert unrelated work. Your ownership is limited to the backend schema/model/service/route changes required by this phase, any narrowly targeted backend tests truly needed to support your implementation, and `handoff/wave-02/phase-05-wave-02-shortage-linkage-query-helper-cleanup/backend.md`.
...
- `handoff/wave-02/phase-05-wave-02-shortage-linkage-query-helper-cleanup/orchestrator.md`
- `backend/app/models/draft.py`
- `backend/app/models/inventory_count.py`
- `backend/app/services/inventory_service.py`
- `backend/app/utils/validators.py`
...
12. Append your work log to `handoff/wave-02/phase-05-wave-02-shortage-linkage-query-helper-cleanup/backend.md` using the required section shape from `handoff/README.md`.
...
You are not alone in the codebase. Do not revert unrelated work. Your ownership is limited to backend regression coverage and `handoff/wave-02/phase-05-wave-02-shortage-linkage-query-helper-cleanup/testing.md`.
...
9. Append your work log to `handoff/wave-02/phase-05-wave-02-shortage-linkage-query-helper-cleanup/testing.md` using the required section shape from `handoff/README.md`.
...
Docs Read
- `handoff/wave-02/phase-05-wave-02-shortage-linkage-query-helper-cleanup/backend.md`
- `handoff/wave-02/phase-05-wave-02-shortage-linkage-query-helper-cleanup/testing.md`
- `handoff/wave-02/phase-05-wave-02-shortage-linkage-query-helper-cleanup/orchestrator.md`
