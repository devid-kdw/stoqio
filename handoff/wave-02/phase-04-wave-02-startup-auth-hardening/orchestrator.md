...
You are not alone in the codebase. Do not revert unrelated work. Your ownership is limited to backend startup/auth code, any targeted backend tests truly required to support your backend change, and `handoff/wave-02/phase-04-wave-02-startup-auth-hardening/backend.md`.
...
7. Append your work log to `handoff/wave-02/phase-04-wave-02-startup-auth-hardening/backend.md` using the section shape required by `handoff/README.md`.
...
You are not alone in the codebase. Do not revert unrelated work. Your ownership is limited to backend regression coverage and `handoff/wave-02/phase-04-wave-02-startup-auth-hardening/testing.md`.
...
5. Append your work log to `handoff/wave-02/phase-04-wave-02-startup-auth-hardening/testing.md` using the section shape required by `handoff/README.md`.
