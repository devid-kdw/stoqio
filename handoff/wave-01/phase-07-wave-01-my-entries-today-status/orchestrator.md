...
- Append your work log to `handoff/wave-01/phase-07-wave-01-my-entries-today-status/backend.md`.
...
Handoff Requirements
- Append your work log to `handoff/wave-01/phase-07-wave-01-my-entries-today-status/frontend.md`.
- Use the section shape required by `handoff/README.md`.
...
Handoff Requirements
- Append your work log to `handoff/wave-01/phase-07-wave-01-my-entries-today-status/testing.md`.
- Use the section shape required by `handoff/README.md`.
- Record files changed, commands run, tests run, open issues, and assumptions.
...
- `handoff/wave-01/phase-07-wave-01-my-entries-today-status/testing.md`
