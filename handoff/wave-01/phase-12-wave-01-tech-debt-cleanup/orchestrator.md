...
- `handoff/wave-01/phase-12-wave-01-tech-debt-cleanup/orchestrator.md`
- `backend/app/api/`
- `backend/app/services/`
- `backend/tests/`
...
- Append your work log to `handoff/wave-01/phase-12-wave-01-tech-debt-cleanup/backend.md`.
...
Handoff Requirements
- Append your work log to `handoff/wave-01/phase-12-wave-01-tech-debt-cleanup/frontend.md`.
- Use the section shape required by `handoff/README.md`.
...
Docs Read
- `handoff/wave-01/phase-12-wave-01-tech-debt-cleanup/orchestrator.md`
- `handoff/wave-01/phase-12-wave-01-tech-debt-cleanup/backend.md`
- `handoff/wave-01/phase-12-wave-01-tech-debt-cleanup/frontend.md`
- `handoff/decisions/decision-log.md` (`DEC-I18N-001`)
...
```bash
git status --short
sed -n '1,260p' handoff/wave-01/phase-12-wave-01-tech-debt-cleanup/backend.md
sed -n '1,260p' handoff/wave-01/phase-12-wave-01-tech-debt-cleanup/frontend.md
