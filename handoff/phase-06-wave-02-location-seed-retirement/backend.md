...
- `handoff/phase-04-first-run-setup/orchestrator.md`
- `handoff/phase-03-authentication/orchestrator.md`
- `handoff/phase-03-authentication/backend.md`
- `handoff/phase-03-authentication/testing.md`
- `handoff/phase-03-authentication/verification_commands.md`
- `handoff/phase-06-wave-02-location-seed-retirement/orchestrator.md`
- `backend/seed.py`
...
- `handoff/phase-03-authentication/testing.md` [MODIFIED] - added a supersession note and removed current instructions to run `seed_location.py`.
- `handoff/phase-03-authentication/verification_commands.md` [MODIFIED] - replaced obsolete seed-helper instructions with the current supported setup path.
- `handoff/phase-03-authentication/backend.md` [MODIFIED] - added a supersession note so the historical closure log stays honest.
- `handoff/phase-03-authentication/orchestrator.md` [MODIFIED] - updated validation/live-environment notes to reflect that the helper is retired.
...
- `handoff/phase-06-wave-02-location-seed-retirement/orchestrator.md` [MODIFIED] - updated the phase state from planned cleanup to completed cleanup.
