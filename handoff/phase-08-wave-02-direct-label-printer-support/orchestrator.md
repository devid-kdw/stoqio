...
Docs Read
- `handoff/phase-08-wave-02-direct-label-printer-support/backend.md`
- `handoff/phase-08-wave-02-direct-label-printer-support/frontend.md`
- `handoff/phase-08-wave-02-direct-label-printer-support/testing.md`
...
- `backend/tests/test_articles.py`
- `frontend/src/pages/warehouse/ArticleDetailPage.tsx`
- `handoff/phase-08-wave-02-direct-label-printer-support/orchestrator.md`
